      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 max-w-4xl w-full">
        ...
        <div className="flex items-center mb-6">
          <div className="w-24 h-24 mr-4">
            <Image
              src="/profile.jpg" // Pastikan gambar disimpan di folder public
              alt="Profile Picture"
              width={96}
              height={96}
          ...
          <div>
            <h1 className="text-black font-bold text-2xl">Reza Ryandi Maulana</h1>
        ...
        <div className="mb-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1 mt-1">
              ...
              <li>Wrote automated tests to ensure consistent code quality.</li>
        ...
        <div className="text-center text-gray-500 text-sm">
          © 2025 Reza Ryandi Maulana. All Rights Reserved.
        </div>
      </div>
    </div>
  );
